...
public class MapTest {
    ...
    public void canProcessMap() {
        ...
        String expectedResult = """
                ...
                String v3 = String.valueOf("key1");
                Integer v4 = Integer.valueOf("333");
                v2.put(v3, v4);
                String v5 = String.valueOf("key2");
    ...
    public void canProcessMapWithNestedMap() {
        ...
        String expectedResult = """
                ...
                String v5 = String.valueOf("nestedKey1");
                String v6 = String.valueOf("kek");
                v4.put(v5, v6);
                v2.put(v3, v4);
                String v7 = String.valueOf("key2");
                Map<String, String> v8 = new Map<String, String>();
                String v9 = String.valueOf("nestedKey2");
                String v10 = String.valueOf("kek x2");
                v8.put(v9, v10);
                v2.put(v7, v8);
                v1.setMapProperty(v2);
                """;
